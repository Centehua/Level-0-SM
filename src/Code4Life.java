...
public class Code4Life {
	...
	/*
	 * private static void playBatmanTheme() { try { AudioInputStream
	 * audioInputStream = AudioSystem.getAudioInputStream(new File(
	 * "/Users/League/Google Drive/league-sounds/batman.wav")); Clip clip =
	 * AudioSystem.getClip(); clip.open(audioInputStream); clip.start();
	 * Thread.sleep(60002); } catch (Exception ex) { ex.printStackTrace(); }
	 */
}
// }
