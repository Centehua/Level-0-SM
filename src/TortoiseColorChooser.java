...
public class TortoiseColorChooser {
	public static void main(String[] args) {
		for (int i = 0; i < 10; i++) {
			...
			+ "Please choose one of the following colors" + ":" + " " + "red" + "  " + "pink" + "  " + "yellow" + "  "
					+ "blue" + "  " + "green" + "  " + "magneta" + "  " + "light gray" + "  " + "orange" + "  "
					+ "cyan");
			...
			// line of code)
			/*
			 * 6/1/17 Update: I added a for loop to create a square since the
			 * previous shape was just a weird line thing
			 */
